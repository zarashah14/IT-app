...
function About() {
  return (
    <div>
      <div className="">
        <h1 className=" mx-5 text-yellow-200 text-left font-extrabold text-4xl">
          {" "}
          Hello world1{" "}
        </h1>
        <h2 className=" mx-2 text-red-500 text-center text-4xl">
          {" "}
          Hello world2{" "}
        </h2>
        <h3 className=" mx-3 text-pink-500 text-right font-extralight text-4xl">
          {" "}
          Hello world3{" "}
        </h3>
        <h4 className=" mx-4 text-blue-500 text-right font-thin text-4xl">
          {" "}
          Hello world4{" "}
        </h4>
        <h5 className=" mx-6 text-orange-400 font-mono text-4xl">
          {" "}
          Hello world5{" "}
        </h5>
        <h6 className=" mx-7 text-gray-500 font-serif text-4xl">
          {" "}
          Hello world6{" "}
        </h6>
      </div>
      <div className="text-center flex flex-col">
        ...
        <p className="subpixel-antialiased line-through">
          The quick brown fox ...
        </p>
